      ...
      contents: [
        {
          ...
          text: [
            ...
            "",
            "محدودیت‌های مهم:",
            "- این سرور فقط متادیتا برمی‌گردونه (عنوان، نویسنده، چکیده، DOI، لینک)، نه متن کامل مقاله.",
            "- برای متن کامل باید از فیلد link یا doi هر نتیجه به سایت ناشر مراجعه کرد.",
